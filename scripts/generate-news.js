...
function buildCloudinaryImageUrl(title, categoryEn, categoryTh, bgPools) {
  ...
  return [
    ...
    'e_brightness:-15',
    'l_lawyernearme-gradient/w_1200,h_150,c_fill/e_gradient_fade,y_0.5/a_180/fl_layer_apply,g_north,o_80',
    ...
    `l_text:Sarabun_68_bold:${encoded},co_white,g_south_west,x_60,y_70,w_900,c_fit,e_shadow:80`,
