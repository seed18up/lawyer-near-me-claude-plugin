...
const TARGET_FILES = ['law/ppc/property/property.json'];
const LAW_NAMES = { 'property.json': 'ทรัพย์สิน' };

const LOG_FILE = 'fetch-dika-property-patch.log';
...
async function main() {
  log('=== fetch-dika-property-patch เริ่ม ' + new Date().toISOString() + ' ===\n');
