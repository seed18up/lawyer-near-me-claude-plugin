...
// query ยาวขึ้น ใช้ text snippet + keyword combo
const LAW_NAMES = {
  'administrative.json':   'ปกครอง',
  'loans.json':            'กู้ยืม',
  'debt-collection.json':  'ทวงหนี้',
  'juvenile.json':         'เยาวชน',
  'constitution.json':     'รัฐธรรมนูญ',
  'company.json':          'บริษัท',
  'tax.json':              'ภาษีอากร',
  'property.json':         'ทรัพย์สิน',
  'civil-procedure.json':  'วิแพ่ง',
  'agency.json':           'ตัวแทน',
  'obligations.json':      'หนี้',
  'criminal.json':         'อาญา',
  'criminal-procedure.json':'วิอาญา',
  'bankruptcy.json':       'ล้มละลาย',
  'inheritance.json':      'มรดก',
  'traffic.json':          'จราจร',
  'consumer-protection.json':'ผู้บริโภค',
...
const LOG_FILE = 'fetch-dika-round9.log';
...
async function main() {
  log('=== fetch-dika-round9 เริ่ม ' + new Date().toISOString() + ' ===\n');
