...
// รอบ 8: retry ทุก gap ที่เหลือ ด้วย query หลากหลายขึ้น
const TARGET_FILES = [
...
const LAW_NAMES = {
  ...
  'family.json':           'ครอบครัว สมรส บิดามารดา',
};

const LOG_FILE = 'fetch-dika-round8.log';
...
async function main() {
  log('=== fetch-dika-round8 เริ่ม ' + new Date().toISOString() + ' ===\n');
