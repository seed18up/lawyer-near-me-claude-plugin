...
// round 11: PDPA + administrative-court + labor-court + obligations gap-fill
const TARGET_FILES = [
  'law/pdpa/pdpa.json',
  'law/administrative-court/administrative-court.json',
  'law/labor-court/labor-court.json',
  'law/constitutional-court-procedure/constitutional-court-procedure.json',
  'law/ip-court/ip-court.json',
...
const LAW_NAMES = {
  'pdpa.json':                              'PDPA คุ้มครองข้อมูลส่วนบุคคล',
  'administrative-court.json':             'ศาลปกครอง คดีปกครอง',
  'labor-court.json':                      'ศาลแรงงาน คดีแรงงาน',
  'constitutional-court-procedure.json':   'ศาลรัฐธรรมนูญ วิธีพิจารณา',
  'ip-court.json':                         'ศาลทรัพย์สินทางปัญญา',
  'obligations.json':                      'หนี้ นิติกรรม สัญญา',
  'property.json':                         'ทรัพย์สิน',
  'loans.json':                            'กู้ยืม ค้ำประกัน จำนอง',
};

const LOG_FILE = 'fetch-dika-round11.log';
...
async function main() {
  log('=== fetch-dika-round11 เริ่ม ' + new Date().toISOString() + ' ===\n');
